    ...
    <section id="blog">
      <div className="px-8 py-16 flex flex-col lg:gap-12 gap-16 lg:flex-row max-w-screen-xl m-auto">
        <div className="space-y-16">
          <div className="flex flex-col gap-4 items-baseline">
            <Image
              ...
              alt="Yoga For Everyone in 2022"
              width={1000}
              height={1000}
            />
            <div className="flex items-center gap-2">
              <span>
                <i className="fa-solid fa-layer-group text-[#ff0000]"></i>
              </span>
              <span>
                By <strong>Admin</strong> | March 11, 2022 | Yoga
              </span>
            </div>
            <h1 className="text-3xl font-bold">Yoga For Everyone in 2022</h1>
            <p>
            ...
            <Link
              href="/"
              className="relative text-white flex items-center gap-2 bg-[#ff0000] font-bold px-6 py-4 after:h-[3.5rem] after:absolute after:w-[13.25rem] after:duration-300 after:ease-linear after:border after:border-[#ff0000] after:-top-3 after:-right-3 hover:after:top-0 hover:after:right-0 mt-6"
            >
        ...
        <div className="space-y-8">
          <div className="flex">
            <input
              className="border h-[3.75rem] py-1 px-5 w-full rounded-tl-xl rounded-bl-xl"
              type="search"
              placeholder="Search..."
            />
            <button className="flex items-center justify-center bg-[#ff0000] text-white text-2xl h-[3.75rem] w-[4.75rem] rounded-br-xl rounded-tr-xl">
          ...
          <div className="bg-[#f8f8f8] p-8 space-y-10">
            ...
            <div className="space-y-6">
              <div className="cursor-pointer flex justify-between border-b border-[#dcd9d9] pb-4 hover:text-[#ff0000] ease-in duration-200">
                <p className="flex items-center gap-2">
                  <span>
                    <i className="fa-solid fa-chevron-right text-[0.75rem]"></i>
                  </span>
          ...
          <div className="bg-[#f8f8f8] p-8 space-y-10">
            ...
            <div className="space-y-6">
              <div className="cursor-pointer flex gap-4 hover:text-[#ff0000] ease-in duration-200">
                <Image
                  src="/images/blog/blog-1.jpg"
                  alt="blog"
                  width={100}
                ...
                />
                <div className="space-y-2">
                  <p className="text-sm">March 22, 2022</p>
                  <h3 className="font-bold">Yoga For Everyone in 2022</h3>
                </div>
              </div>
              <div className="cursor-pointer flex gap-4 hover:text-[#ff0000] ease-in duration-200">
                <Image
                ...
                <div className="space-y-2">
                  <p className="text-sm">March 22, 2022</p>
                  <h3 className="font-bold">Getting Back Into CrossFit</h3>
                </div>
              </div>
              <div className="cursor-pointer flex gap-4 hover:text-[#ff0000] ease-in duration-200">
                <Image
                ...
                <div className="space-y-2">
                  <p className="text-sm">March 22, 2022</p>
                  <h3 className="font-bold">How To Get Lean For The Summer</h3>
                </div>
              </div>
              <div className="cursor-pointer flex gap-4 hover:text-[#ff0000] ease-in duration-200">
                <Image
                ...
                <div className="space-y-2">
                  <p className="text-sm">March 22, 2022</p>
                  <h3 className="font-bold">Meet Fitness Abassador Grace</h3>
                </div>
              </div>
              <div className="cursor-pointer flex gap-4 hover:text-[#ff0000] ease-in duration-200">
                <Image
                ...
                <div className="space-y-2">
                  <p className="text-sm">March 22, 2022</p>
                  <h3 className="font-bold">The best Meditation</h3>
                </div>
              </div>
              <div className="cursor-pointer flex gap-4 hover:text-[#ff0000] ease-in duration-200">
                <Image
                ...
                <div className="space-y-2">
                  <p className="text-sm">March 22, 2022</p>
                  <h3 className="font-bold">Learn Boxing With Mike Tyson</h3>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-[#f8f8f8] p-8 space-y-10">
            ...
            <div className="flex gap-3 text-[#646464] font-semibold flex-wrap">
              <p className="bg-white py-1 px-3.5 hover:text-[#ff0000] ease-in duration-200 cursor-pointer">
                #Crossfit
              </p>
              <p className="bg-white py-1 px-3.5 hover:text-[#ff0000] ease-in duration-200 cursor-pointer">
                #Fitness
