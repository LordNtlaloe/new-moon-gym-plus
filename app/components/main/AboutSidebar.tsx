        ...
        <div className="absolute inset-0 lg:left-[70%] bg-white z-[1001] p-8 overflow-y-auto space-y-12">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setAboutSidebar(false)}>
              <i className="fa-solid fa-xmark hover:text-[#ff0000] duration-300 ease-linear text-3xl"></i>
            </button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <span>
                <i className="fa-solid fa-location-dot text-[#ff0000]"></i>
              </span>
              <span>
            ...
            <div className="flex items-center gap-2">
              <span>
                <i className="fa-solid fa-phone text-[#ff0000]"></i>
              </span>
              <span>
                <p>+123-678800090</p>
              </span>
            ...
            <div className="flex items-center gap-2">
              <span>
                <i className="fa-solid fa-envelope text-[#ff0000]"></i>
              </span>
              <span>
