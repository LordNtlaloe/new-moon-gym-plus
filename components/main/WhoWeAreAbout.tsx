        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:py-32 max-w-screen-xl m-auto">
          <div className="relative flex flex-col gap-6 items-center text-center lg:items-start lg:text-left">
            ...
            <div>
              <Link
                href="/"
                className="relative text-white flex items-center gap-2 bg-[#ff0000] font-bold px-8 py-4 after:h-[3.5rem] after:absolute after:w-[12rem] after:duration-300 after:ease-linear after:border after:border-[#ff0000] hover:after:border-[#ff0000] after:-top-3 after:-right-4 hover:after:top-0 hover:after:right-0 mt-4"
              >
