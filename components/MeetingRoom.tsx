...
import { Users, LayoutList, BetweenHorizonalEnd, BetweenVerticalEnd, Grid } from 'lucide-react';
...
const SessionRoom = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden pt-4 text-white">
      ...
      <div className="fixed bottom-0 flex w-full items-center justify-center gap-5 mt-10">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="border-dark-1 bg-dark-1 text-white">
            {['Grid', 'Speaker-Vert', 'Speaker-Horiz'].map((item, index) => (
              <div key={index}>
